...
export default function StaffFoundReview() {
  usePageMetadata("Staff Found Review", "/images/LAFLogo.png");
    ...
    return (
      <div style={styles.container}>
        ...
        <div style={styles.errorContainer}>
          ...
          <p>
            The requested item could not be found or has already been processed.
          </p>
          <button
          ...
          <div style={styles.header}>
            ...
            <div style={styles.headerInfo}>
              ...
              <p style={styles.subtitle}>
                Review found item report before publishing
              </p>
            </div>
          </div>
                  ...
                  <div style={styles.actionButtons}>
                    ...
                    >
                      {processing ? (
                        ...
                        <>
                          <IoCheckmarkCircleOutline size={20} /> Approve Post
                        </>
                      )}
                    </button>
                    <button
...
const styles = {
  ...
  header: { display: "flex", flexDirection: "column", marginBottom: "30px" },
  backNavButton: {
    display: "flex",
    alignItems: "center",
    gap: "8px",

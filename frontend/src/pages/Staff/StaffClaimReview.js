...
const styles = {
  ...
  timelineItem: { position: "relative", marginBottom: "24px", display: "flex", alignItems: "flex-start" },
  timelineDot: { position: "absolute", left: "-28px", top: "4px", width: "12px", height: "12px", borderRadius: "50%", backgroundColor: "#1A1851", border: "3px solid #ffffff", boxShadow: "0 0 0 3px rgba(26, 24, 81, 0.1)" },
  timelineContent: { flex: 1 },
  timelineTitle: { fontSize: "15px", fontWeight: "600", color: "#1e293b", marginBottom: "4px" },
  timelineDate: { fontSize: "14px", color: "#64748b" },
  proofImages: { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(120px, 1fr))", gap: "12px", marginBottom: "20px" },
  proofText: { backgroundColor: "#f8fafc", padding: "20px", borderRadius: "12px", marginBottom: "20px", border: "1px solid #e2e8f0" },
  proofValidation: { display: "flex", alignItems: "center", gap: "10px", padding: "16px", backgroundColor: "#d1fae5", color: "#065f46", borderRadius: "10px", fontSize: "14px", fontWeight: "600" },
  ...
  actionNotes: { padding: "16px", backgroundColor: "#fef3c7", color: "#92400e", borderRadius: "10px", fontSize: "14px", textAlign: "center", border: "1px solid #fbbf24" },
};
